...
#define UNIXFD_DEVICE_USB_CDC   ${CONFIG_UNIXFD_DEVICE_USB_CDC?then(1,0)}
...
#define UNIXFD_STDIN_DEVICE     "/dev/null"
    <#break>
  <#case "USB-CDC">
#define UNIXFD_STDIN_USB_CDC    1
#define UNIXFD_STDIN_DEVICE     "/dev/usb-cdc"
    <#break>
  <#default>
...
#define UNIXFD_STDOUT_DEVICE    "/dev/null"
    <#break>
  <#case "USB-CDC">
#define UNIXFD_STDOUT_USB_CDC   1
#define UNIXFD_STDOUT_DEVICE    "/dev/usb-cdc"
    <#break>
  <#default>
...
#define UNIXFD_STDERR_DEVICE    "/dev/null"
    <#break>
  <#case "USB-CDC">
#define UNIXFD_STDERR_USB_CDC   1
#define UNIXFD_STDERR_DEVICE    "/dev/usb-cdc"
    <#break>
  <#default>
